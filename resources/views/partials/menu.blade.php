...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="{{route('admin')}}" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">ClothStore</span>
      </a>
        ...
        <ul class="dropdown-menu dropdown-menu-end">
          ...
          <li>
            <a class="dropdown-item" href="{{route('index')}}">
              ...
              <span class="align-middle">Ir a la web</span>
            </a>
          </li>
          <li>
            <div class="dropdown-divider"></div>
          ...
          <li>
            <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class='bx bx-log-out me-2'></i>{{ 'Cerrar sesion' }}</a>
