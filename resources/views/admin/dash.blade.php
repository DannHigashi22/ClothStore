                  ...
                  <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                      <div class="avatar flex-shrink-0">
                        <img src="data:image/png;base64,"/>
                      </div>
                    </div>
                    <span class="fw-semibold d-block mb-1">Pedidos Hoy:</span>
                    <h3 class="card-title mb-2">{{$orderstoday->count()}} Ordenes</h3>
                  </div>
                </div>
              </div>
              <div class="col-lg-6 col-md-12 col-6 mb-4">
                <div class="card">
                  <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                      <div class="avatar flex-shrink-0">
                        <img src="data:image/png;base64,"/>
                      </div>
                    </div>
              ...
              <div class="col-6 mb-4">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h3 class="card-title text-nowrap mb-2">{{$orders->count()}} Ordenes</h3>
                  </div>
                </div>
              </div>
              <div class="col-6 mb-4">
                    ...
                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                      <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                        <div class="card-title">
                          ...
                          <span class="badge bg-label-warning rounded-pill">Ultimos 6 meses</span>
                        </div>
